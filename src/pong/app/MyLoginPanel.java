...
public class MyLoginPanel extends JPanel {
	...
	public MyLoginPanel() {
		...
		tfPwd.setBounds(90,170, 200,50);
					//x,y w, h
		btnLogin.setBounds(90,280,100,50);
		btnLogin.setBackground(new Color(123,123,200));//r,g,b
		btnLogin.setBorder(new LineBorder(Color.gray,3));
		btnJoin.setBounds(190,280,100,50);
		btnJoin.setBackground(new Color(90,240,240));//r,g,b
		btnJoin.setBorder(new LineBorder(Color.gray,3));
