...
public class PongGui extends JFrame{
	...
	/** 로그인을 처리하는 메서드
	 * 퐁씨 성을 가진 사람들이 로그인을 하면 로긍니을 승인처리하며,
	 * 콩씨인 경우는 로그인 되지 않고 예외가 발생한다.
	 */
	private void login()
	//private이면 문서화주석 안받음 public만가능 원래 private였음
	 ...
	 * 이벤트 처리
	 */
	public class MyHandler implements ActionListener //=>원래 public 없엇음
	{
